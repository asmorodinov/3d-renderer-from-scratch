...
void drawTriangle(const Triangle<Var>& t, const glm::mat4& transform, Shader<Const, Var>& shader, Screen& screen,
    ...
    InterpolatedVariables<Var> iv0 = {p0.z, 1.0f / p0.w, t0, {1, 0, 0}};
    InterpolatedVariables<Var> iv1 = {p1.z, 1.0f / p1.w, t1, {0, 1, 0}};
    InterpolatedVariables<Var> iv2 = {p2.z, 1.0f / p2.w, t2, {0, 0, 1}};
